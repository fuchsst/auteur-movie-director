    ...
    <div class="details-content">
          ...
          <div class="file-list">
            {#each commit.files as file}
              ...
              >
                ...
                <span class="change-type" style:color={getChangeTypeColor(file.changeType)}>
      ...
      {#if selectedFile}
        <div class="diff-section">
          ...
          <DiffViewer {projectId} {commitHash} filePath={selectedFile} />
        </div>
      {/if}
    </div>
  {:else}
  ...
  <div class="tag-dialog-overlay" on:click={() => (showTagDialog = false)}>
    <div class="tag-dialog" on:click|stopPropagation>
      ...
      <div class="dialog-actions">
        <button class="cancel-button" on:click={() => (showTagDialog = false)}> Cancel </button>
        <button class="create-button" on:click={createTag} disabled={!tagName.trim()}>
          Create Tag
        </button>
      </div>
    </div>
