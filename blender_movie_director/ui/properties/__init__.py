...
from . import service_properties
...
def register():
    ...
    # Register service properties first
    service_properties.register()

    # Register asset properties
    ...
    bpy.types.Object.movie_director_character = PointerProperty(
        type=MovieDirectorCharacterProperties
    )
...
def unregister():
    ...
    # Unregister service properties
    service_properties.unregister()
