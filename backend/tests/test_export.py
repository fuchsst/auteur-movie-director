...
from app.services.export import ProjectExportService, ExportFormat
from app.schemas.project import ExportOptions, ExportManifest
...
class TestProjectExportService:
    ...
    async def test_export_with_progress(self, export_service, mock_project_dir):
        ...
        with patch.object(export_service, 'workspace_root', mock_project_dir.parent):
            ...
            await export_service.export_project(
                "test-project", options, progress_callback
            )
    ...
    async def test_bundle_git_history(self, export_service, mock_project_dir):
        ...
        with patch('asyncio.create_subprocess_exec') as mock_subprocess:
            ...
            await export_service._bundle_git_repo(
                mock_project_dir,
                mock_project_dir / "staging"
            )
    ...
    async def test_bundle_lfs_objects(self, export_service, mock_project_dir):
        ...
        await export_service._bundle_lfs_objects(
            mock_project_dir, staging_dir
        )
    ...
    async def test_create_manifest(self, export_service, mock_project_dir):
        ...
        manifest = await export_service._create_manifest(
            "test-project", mock_project_dir, options
        )
